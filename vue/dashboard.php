...
<section class="dashboard">
    <div class="sidebar">
                ...
                <a href="dashboard.php?manage=user_account" >
        ...
        <div class="zone_table">
            ...
            ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="icon_crud">
                                         <a href="#"  onclick="client_data('<?php echo $value['ID_client']?>')">
                                        ...
                                        <a hred="#" onclick="delete_data('<?php echo $value['ID_client']?>' , '<?php echo 'ID_client' ?>','<?php echo $table?>')">
...
<script src="../assets/js/client_data.js"></script>
